#!/usr/bin/env python3
"""Collect 2026 CFB Week 2 games + box scores from ESPN.
...
Usage: collect_cfb_week2.py DAYS_DIR TRACKER_JSON BOXSCORE_DIR
...
def main(days_dir, tracker_path, box_dir):
    ...
    doc = {
        'schema_version': '1.0.0', 'season': 2026, 'week': 2, 'built_at': built,
        'purpose': 'Track every FBS college football game from 2026 Week 2 (window 2026-09-10..2026-09-14) with results and, once final, box-score stats. These facts feed the CFB model; book lines never do.',
        'scope': 'FBS only (ESPN groups=80). FCS excluded.',
        'source': 'ESPN scoreboard API site.api.espn.com/apis/site/v2/sports/football/college-football/scoreboard per date, window 2026-09-10..2026-09-14',
