...
Files in this folder carry GitHub web-upload numeric prefixes (e.g. `216-roster_weekly_2025_part1.csv`). Match files by the suffix names listed below. Same convention applies in tools/pff/ and tools/espn/.
